...
func (x *PrimitiveID) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_public_public_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x1d, 0x0a, 0x0b, 0x50, 0x72, 0x69, 0x6d, 0x69,
	0x74, 0x69, 0x76, 0x65, 0x49, 0x44, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x42, 0x43, 0x5a, 0x41, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x62, 0x69, 0x6c, 0x65, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_public_public_proto_goTypes = []interface{}{
	...
	(*PrimitiveID)(nil), // 1: bellis.backend.mobile.public.PrimitiveID
}
